...
const { TextureLoader, RepeatWrapping, LinearFilter, ClampToEdgeWrapping, RawShaderMaterial, DoubleSide, AdditiveBlending, Vector3, BufferGeometry, BufferAttribute, Mesh, Matrix4 } = require("three");
...
( function ( root, factory ) {
  ...
  var initMaterial =  ( function () {
    ...
    return function () {
      ...
      nzw.wrapS = RepeatWrapping;
      nzw.wrapT = RepeatWrapping;
      nzw.magFilter = LinearFilter;
      nzw.minFilter = LinearFilter;

      var fireProfile = textureLoader.load( VolumetricFire.texturePath + 'firetex.png' );
      fireProfile.wrapS = ClampToEdgeWrapping;
      fireProfile.wrapT = ClampToEdgeWrapping;
      fireProfile.magFilter = LinearFilter;
      fireProfile.minFilter = LinearFilter;
  ...
  var VolumetricFire = function ( width, height, depth, sliceSpacing, camera ) {
    ...
    this._posCorners = [
      new Vector3( -widthHalf, -heightHalf, -depthHalf ),
      new Vector3(  widthHalf, -heightHalf, -depthHalf ),
      new Vector3( -widthHalf,  heightHalf, -depthHalf ),
      new Vector3(  widthHalf,  heightHalf, -depthHalf ),
      new Vector3( -widthHalf, -heightHalf,  depthHalf ),
    ...
    geometry.addAttribute( 'tex',      new BufferAttribute( tex,      3 ) );
